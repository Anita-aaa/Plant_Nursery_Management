        ...
        <section className="bg-light py-5">
            <div className="container py-4 px-3 rounded bg-white">
                <header className="mb-5">
                    <h1 className="display-4 text-center">Help - FloraCare</h1>
                    <p className="lead text-center">
                        Your go-to guide for navigating FloraCarer. Find answers to common
                ...
                <section id="getting-started" className="section-title">
                    ...
                    <p>
                        <strong>What is FloraCare?</strong>
                        <br />
                        FloraCare is your go-to online store for buying a wide range of
                ...
                <section id="contact-us" className="section-title">
                    ...
                    <p>
                        <strong>Email:</strong>{" "}
                        <Link to="mailto:at9941787@gmail.com">at9941787@gmail.com</Link>
                    </p>
                    <p>

                        <strong>Phone:</strong>
                        <Link to="tel:+9779843280284"> +91 7463980230</Link>
                    </p>
                    <p>
